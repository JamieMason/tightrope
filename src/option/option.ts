...
export namespace Option {
  ...
  export type Type<T> = T extends Option<infer V> ? V : never;

  /** Create a Union of 2 Options */
  export type Union<B extends Option.Any, A extends Option.Any> = Option<
    Option.Type<B> | Option.Type<A>
  >;
}
...
export class Some<T> {
  ...
  static create<T>(value: T): Option<T> {
